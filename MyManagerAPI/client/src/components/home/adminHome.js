    ...
    if (user.userTypeId == 1) {
        return (
            <div className="flex flex-col items-center"
                ...
                <h3 className="font-metro text-3xl mb-6 -mt-10" >What would you like to do?</h3>
                <div className="flex bg-maroon rounded font-techno justify-center border-white w-80 border-2 p-4 mt-2 shadow-md m-10" >
                    <div className="bg-lite-maroon rounded box-border  border-2 p-2  ">
